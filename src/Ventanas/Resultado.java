...
public class Resultado extends javax.swing.JFrame {
    ...
    public void mostrarResultado(int carta) {
        JOptionPane.showMessageDialog(this,"Su carta es!!!!!!");
        //obteniendo la imagen de fondo
        Image imagen = new ImageIcon(getClass().getResource("/imagenes/" + carta + ".jpg")).getImage();
